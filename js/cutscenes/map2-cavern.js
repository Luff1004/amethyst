...
(() => {
  ...
  R(1400000000, 'lighteternal', 'The Light Eternal', 48,
    ...
    { duration: 16000, revealAt: 0.63, captions: [
      { a: 0.04, b: 0.24, en: '每个洞穴都记得太阳', size: 26, pos: 'top', style: 'fly', from: 'top' },
      { a: 0.28, b: 0.5, en: '这颗从未放手', size: 26, style: 'fly', from: 'right' },
  ...
  R(2800000000, 'cavernofinfinity', 'Cavern of Infinity', 210,
    ...
    { duration: 17000, revealAt: 0.63, hue2: 260, captions: [
      { a: 0.04, b: 0.24, en: '隧道从未遇见尽头', size: 26, pos: 'top', style: 'fly', from: 'top', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.28, b: 0.5, en: '只是不断向下延伸', size: 26, style: 'fly', from: 'bottom', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.66, b: 1.4, en: '無限', v: true, size: 40, x: 0.82, y: 0.36, font: 'ui-monospace,"SF Mono",Consolas,monospace' },
    ] });
  R(4200000000, 'crystalbornmonarch', 'Crystalborn Monarch', 172,
    ...
    { duration: 17500, revealAt: 0.64, captions: [
      { a: 0.04, b: 0.25, en: '洞穴选择了自己的王', size: 26, pos: 'top', style: 'engrave' },
      { a: 0.29, b: 0.52, en: '从岩壁中将他孕育而生', size: 26, style: 'engrave' },
  ...
  R(6500000000, 'radiantabyss', 'Radiant Abyss', 190,
    ...
    { duration: 18000, revealAt: 0.64, hue2: 220, captions: [
      { a: 0.04, b: 0.25, en: '光本不该抵达这般深处', size: 26, pos: 'top', style: 'fly', from: 'left' },
      { a: 0.29, b: 0.52, en: '却从未停止照耀', size: 26, style: 'fly', from: 'right' },
  ...
  R(9800000000, 'lastrefraction', 'The Last Refraction', 300,
    ...
    { duration: 19000, revealAt: 0.65, hue2: 190, captions: [
      { a: 0.04, b: 0.26, en: 'كل ضوء ينتهي في مكان ما', pos: 'top', size: 24, style: 'fly', from: 'top' },
      { a: 0.3, b: 0.54, en: 'هنا ينحني للمرة الأخيرة', size: 24, style: 'fly', from: 'left' },
      { a: 0.69, b: 0.95, en: 'الضوء الأخير', pos: 'center', size: 26, style: 'fly', from: 'top' },
    ] });
})();

...
(() => {
  ...
  R({
    ...
    captions: [
      { a: 0.04, b: 0.2, ko: '고요 속에서', en: 'IN THE SILENCE', pos: 'top' },
      { a: 0.22, b: 0.4, ko: '무언가가 눈을 떴다', en: 'SOMETHING OPENED ITS EYES', pos: 'center' },
      { a: 0.42, b: 0.62, ko: '수많은 시선이 당신을 향한다', en: 'A THOUSAND GAZES FIND YOU' },
      { a: 0.74, b: 1.4, ko: '눈을 돌릴 수 없다', en: 'THERE IS NO LOOKING AWAY' },
    ],
    draw(g, e) {

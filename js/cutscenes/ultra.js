...
(() => {
  ...
  G.cutscenes.register({
    id: 'watcher', name: 'The Watcher', odds: 1000000000000, tier: 'secret', zone: 0, snd: 'rise:heart hit:whomp tail:echo amb:space root:73 scale:phrygian', duration: 17000, revealAt: 0.72,

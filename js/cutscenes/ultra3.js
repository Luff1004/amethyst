...
(() => {
  ...
  R({
    ...
    captions: [
      { a: 0.04, b: 0.2, en: 'SOMEONE LEFT THIS RUNNING', pos: 'top', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.22, b: 0.4, en: 'DEEP WHERE NO SIGNAL SHOULD REACH', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.42, b: 0.6, en: 'IT KEEPS PLAYING ANYWAY', pos: 'center', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.72, b: 1.4, en: 'PRETENDING EVERYTHING IS FINE', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
    ],
    draw(g, e) {

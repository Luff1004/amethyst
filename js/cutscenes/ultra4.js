...
(() => {
  ...
  R({
    ...
    captions: [
      { a: 0.04, b: 0.2, en: 'THE THERMAL RIG SHOULD HAVE MELTED', pos: 'top', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.22, b: 0.4, en: 'INSTEAD IT KEPT RECORDING', pos: 'center', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.42, b: 0.6, en: 'ONE FRAME, OVER AND OVER', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
      { a: 0.72, b: 1.4, en: 'SOMETHING DOWN HERE IS STILL WARM ENOUGH TO WATCH', style: 'type', font: 'ui-monospace,"SF Mono",Consolas,monospace' },
    ],
    draw(g, e) {

...
G.data.tutorialSteps = [
  ...
  { title: '크리스탈', body: '1억대 이상 광물을 처음 발견하면 크리스탈 탭이 열립니다. 코인을 크리스탈로 교환해 상자를 열고, 나온 크리스탈을 마시면 다음 클릭 한 번에 큰 행운을 몰아줍니다.' },
  { title: '설정', body: '오른쪽 위 톱니바퀴에서 컷신 표시 방식, 알림 스타일 등을 취향대로 바꿀 수 있습니다.' },
  { title: '준비 완료', body: '연습용으로 견습생의 크리스탈(LUCK +50)을 하나 드립니다. 바로 장전해 두었으니 화면을 한 번 탭해보세요. 이 크리스탈은 상점에는 절대 나오지 않는 튜토리얼 전용입니다.' },
];
